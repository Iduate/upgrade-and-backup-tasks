    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  ADD PATIENT NEW VITALS</h4>
            </div>
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addVitals" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="Height" id="exampleInputEmail1"  placeholder="">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> Weight </label>
                        <input type="text" class="form-control" name="Weight" id="exampleInputEmail1"  placeholder="">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="Pulse" id="exampleInputEmail1"  placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> Temperature </label>
                        <input type="text" class="form-control" name="Temperature" id="exampleInputEmail1"  placeholder="">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> Respiration </label>
                        <input type="text" class="form-control" name="Respiration" id="exampleInputEmail1"  placeholder="">
                    </div>
                    ...
                    <?php 
                        foreach($vitals as $vital){
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="v<?php echo $vital->id;?>" id="exampleInputEmail1" >
                            </div>
                            <?php
                        }
                    ?>
...
$(document).ready(function () {
        var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "patient/getVitalsAppointment",
                type: 'POST',
            },
            scroller: {
