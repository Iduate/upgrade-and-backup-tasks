...
.hmsNoti{position:fixed; bottom:30px; right:30px;width:300px;
                            ...
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                       ...
                                       <?php } else if($this->ion_auth->in_group(array('Laboratorist'))){?>
...
timer=setInterval(() => {
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            if(response){
                $(".x_name").html(response.sender)
                $(".x_msg").html(response.msg)
                $(".xerdocs_msg").fadeIn();
                $("#x_a").attr("href","home/chat?id="+response.cid)
                sound = new Howl({
