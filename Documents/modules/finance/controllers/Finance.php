...
class Finance extends MX_Controller {
    ...
    public function addPaymentView() {
        ...
        if($data['patients']->patient_type != "Private Patient"){
            $data['hmo']=$this->finance_model->getHMOById($data['patients']->insurance_id);
        }
        $this->load->view('home/dashboard'); // just the header file
...
// Validating Description Field
    ...
    function addInsurance(){
        ...
        if($id==null)
            $this->finance_model->addInsurance($data);
        else
...
// } 
    ...
    public function getInsuranceInfo() {
        ...
        // Get users
        $response = $this->finance_model->getInsuranceInfo($searchTerm);
