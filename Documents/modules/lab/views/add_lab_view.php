...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel col-md-4">
            ...
            <!-- Add lab test view -->
                <header class="panel-heading no-print" style="margin-bottom:25px">
                    <p style="color:red; font-weight:bold; font-size:15px;"><?=$add_error->error;?></p>
                    <form action="lab/addList" method="post"  enctype="multipart/form-data">
                        <label style="color:green; font-size:14px">Add a New Type of Test</label><br/>
                        <input type="text" class="form-control pay_in default" name="test_name" value="<?=$add_error->name;?>"  placeholder="Enter Test Name"/>
                        ...
                        <input type="text" style="display:none" class="form-control pay_in default" name="cat_name"  placeholder="Enter Category Name" id="add_cat"/>
                        <input type="text" class="form-control pay_in default" name="test_price" value="<?=$add_error->price;?>"  placeholder="Enter Test Price"/>
                        <button type="submit" name="submit" class="btn btn-info">Submit</button>
                    </form>
                    
                </header>
            <!-- End of add lab test view -->
