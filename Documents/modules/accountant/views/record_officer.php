                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($officers as $officer) { ?>
                            <tr class="">
                                <td style="width:10%;"><img style="width:95%;" src="<?php echo $officer->img_url; ?>"></td>
                                <td> <?php echo $officer->name; ?></td>
                                <td><?php echo $officer->email; ?></td>
                                <td class="center"><?php echo $officer->address; ?></td>
                                <td><?php echo $officer->phone; ?></td>
                                <td class="no-print">
                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $officer->id; ?>"><i class="fa fa-edit"> </i></button>   
                                    <!-- <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="accountant/delete?id=<?php echo $officer->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i></a> -->
                                </td>
                            </tr>
                        <?php } ?>
