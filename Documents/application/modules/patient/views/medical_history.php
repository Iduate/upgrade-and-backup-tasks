            ...
            <section class="panel-body">   
                <header class="panel-heading tab-bg-dark-navy-blueee">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#vitals"> Vitals </a> 
                        </li>
                        <?php
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php 
                                                    foreach($vitalsGroup as $vital){
                                                    ?>
                                                        <th><?php echo $vital->name;?></th>
                                                    <?php
                                                    }
                                                ?>
                                                <th>Vitals By</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($vitals as $vital) { ?>
                                                <tr class="">
                                                    ...
                                                    <td><?php echo date('d M, Y', $vital->time); ?></td>
                                                    ...
                                                    <td> <?php echo $vital->respiration;?></td>
                                                    <!-- custom hospital vitals -->
                                                    <?php 
                                                        foreach($vitalsGroup as $v){
                                                            foreach($cvitals as $cv){
                                                                $is=false;
                                                                if($v->id == $cv->form_id && $vital->id == $cv->vital_id){
                                                                    $is=true;
                                                        ?>
                                                                <td><?php echo $cv->data;?></td>
                                                        <?php
                                                                    continue;
                                                                }
                                                            }
                                                    ...
                                                    ?>
                                                    <td> <?php echo $this->patient_model->vitalsBy($vital->vitals_by);?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <?php foreach ($medical_histories as $medical_history) { ?>
                                                <tr class="">
                                                    ...
                                                    <?php if (!$this->ion_auth->in_group(array('Patient'))) { ?>
                                                        ...
                                                        <?php } ?>
                                                            <a type="button" class="btn btn-info btn-xs btn_width detailsbutton case" title="View this case" data-toggle = "modal" data-id="<?php echo $medical_history->id; ?>"><i class="fa fa-file"> </i> </a>';
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>
            ...
            <div class="modal-body row">
                <form role="form" id="medical_historyEditForm" class="clearfix" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_1"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_1" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_2"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_2" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_3"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_3" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_4"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_4" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_5"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_5" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_6"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_6" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_7"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_7" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_8"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_8" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_9"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_9" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12" style="display:none">
                        <label for="exampleInputEmail1" id="form_10"></label>
                        <input type="text" class="form-control form-control-inline input-medium" name="form_10" id="exampleInputEmail1" value='' placeholder="">
                    </div>
...
<script type="text/javascript">
    $(".table").on("click", ".editbutton", function () {
        ...
        $('#medical_historyEditForm').find('#form_1').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_2').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_3').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_4').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_5').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_6').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_7').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_8').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_9').parent().css("display","none")
        $('#medical_historyEditForm').find('#form_10').parent().css("display","none")
        $.ajax({
            ...
            if(response.forms){
                if(response.forms.form_1 !=""){
                    $('#medical_historyEditForm').find('#form_1').html(response.forms.form_1).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_1"]').val(response.medical_history.form_1).end()
                }
                if(response.forms.form_2 !=""){
                    $('#medical_historyEditForm').find('#form_2').html(response.forms.form_2).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_2"]').val(response.medical_history.form_2).end()
                }
                if(response.forms.form_3 !=""){
                    $('#medical_historyEditForm').find('#form_3').html(response.forms.form_3).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_3"]').val(response.medical_history.form_3).end()
                }
                if(response.forms.form_4 !=""){
                    $('#medical_historyEditForm').find('#form_4').html(response.forms.form_4).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_4"]').val(response.medical_history.form_4).end()
                }
                if(response.forms.form_5 !=""){
                    $('#medical_historyEditForm').find('#form_5').html(response.forms.form_5).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_5"]').val(response.medical_history.form_5).end()
                }
                if(response.forms.form_6 !=""){
                    $('#medical_historyEditForm').find('#form_6').html(response.forms.form_6).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_6"]').val(response.medical_history.form_6).end()
                }
                if(response.forms.form_7 !=""){
                    $('#medical_historyEditForm').find('#form_7').html(response.forms.form_7).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_7"]').val(response.medical_history.form_7).end()
                }
                if(response.forms.form_8 !=""){
                    $('#medical_historyEditForm').find('#form_8').html(response.forms.form_8).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_8"]').val(response.medical_history.form_8).end()
                }
                if(response.forms.form_9 !=""){
                    $('#medical_historyEditForm').find('#form_9').html(response.forms.form_9).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_9"]').val(response.medical_history.form_9).end()
                }
                if(response.forms.form_0 !=""){
                    $('#medical_historyEditForm').find('#form_10').html(response.forms.form_0).parent().css("display","block").end()
                    $('#medical_historyEditForm').find('[name="form_10"]').val(response.medical_history.form_0).end()
                }
            }
