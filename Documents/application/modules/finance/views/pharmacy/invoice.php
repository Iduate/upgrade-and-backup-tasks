        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div  class="panel-body col-md-5 panel-moree" id="invoice" style="font-size: 10px;">
                    <div class="row invoice-list"  style="margin-bottom:0">

                    <div class="panel-body">
                        <div class="col-md-12"> <img src="<?php echo $settings->logo; ?>" width="100%"></div>
                    </div>
                        ...
                        <?php } else if (!empty($payment->prescription_id)) { ?>
                            <div class="col-lg-4 col-sm-4">
                            <h4> <?php echo lang('bill_to'); ?> :</h4>
                                <p>
                                    <?php
                                    //get the prescription
                                    $pres=$this->prescription_model->getPrescriptionById($payment->prescription_id);
                                    $patient_info = $this->db->get_where('patient', array('id' => $pres->patient))->row();
                                    echo $patient_info->name . ' <br>';
                                    echo "P:  $patient_info->phone"
                                    ?>
                                </p>
                            </div>
                        <?php }?>
                        ...
                        <?php
                            ...
                            echo "<b>Patient Category:</b> ".$patient_info->patient_type. "<br/><b>Insurance: </b> ".$hmo->name."<br/><b>Sponsor:</b> ".$sp->name;
                        ?>
                        <br/><br/>
                        </div>
