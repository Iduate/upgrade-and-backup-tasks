    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="doctor/addDepartment" class="clearfix" method="post" enctype="multipart/form-data">
                    <input type="hidden" value=<?php echo $this->input->get("doctor");?> name="doctor"/>
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control m-bot15 js-example-basic-single" name="department" value=''>
                            <?php 
                            $d_dept=explode("|",$doctor->department);
                            foreach ($departments as $department) { 
                                foreach($d_dept as $dept){
...
<script>
    $(document).ready(function () {
        var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "doctor/getDepartments",
                type: 'POST',
                data:{"doctor":<?php echo $this->input->get("doctor");?>}
            },
            scroller: {
