            ...
            <div class="modal-body">
                <form role="form" action="bed/addBed" class="clearfix row" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
                        ...
                        <select class="form-control" name="category" value='' id="category1">
                            <?php 
                            $cat=array();
                            foreach ($categories as $category) { ?>
                                ...
                                $cat[$category->category]=$category->price;
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" name="price" id="price1" value='<?php echo $bed->price;?>' placeholder="">
                    </div>
                    <div class="form-group col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editBedForm" class="clearfix row" action="bed/addBed" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('bed_category'); ?></label>
                        <select class="form-control" name="category" value='' id="category2">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1">Price</label>
                        <input type="text" class="form-control" name="price" id="price2" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="exampleInputEmail1"><?php echo lang('description'); ?></label>
                        <input type="text" class="form-control" name="description" id="exampleInputEmail1" value='' placeholder="">
    ...
    $(document).ready(function () {
        $(".table").on("click", ".editbutton", function () {
            ...
            $.ajax({
                ...
                $('#editBedForm').find('[name="price"]').val(response.bed.price).end()
            });
        });
    });
</script>
