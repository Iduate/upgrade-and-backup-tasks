                    ...
                    <div class="clearfix">
                        ...
                        <form role="form" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
                            <div class="">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control m-bot15" id="patientchoose" name="patient" value=''>
                                        ...
                                        if (!empty($patient->name)) { ?>
                                            <option value="<?php echo $patient->id; ?>" selected="selected"><?php echo $patient->name; ?> - (<?php echo lang('id'); ?> : <?php echo $patient->id; ?>)</option>  
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6"  id="medicine_block">
