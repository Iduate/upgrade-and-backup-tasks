        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="medical_historyEditForm" class="clearfix" action="patient/addMedicalHistory" method="post" enctype="multipart/form-data">
                    ...
                    <div class="panel col-md-12 no-print">
                        <a class="btn btn-info invoice_button pull-right" a href="#" id="labprint"><i class="fa fa-print"></i> <?php echo lang('print'); ?> </a>
                    </div>
...
<script>
    ...
    $("#ltest-sample").on("click", ".detailsbutton", function () {
        ...
        $.ajax({
            ...
            $("#labprint").attr("href","lab/invoice?id="+iid)
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".xrayview", function () {
        ...
        $.ajax({
            ...
            controller = controller+ " <a href='lab/radInvoice?id="+ iid+"'><div id='' class='btn green btn-xs'>"+
                "<i class='fa fa-image'></i> Print "
                "</div></a>";
