                ...
                <input type="hidden" value="general" name="type"/>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control m-bot15" name="patient_type" id="patient_type" value='' onchange="getInsurance()">
                                ...
                                <option value="HMO Insurance">HMO Patient </option>
                                <option value="Corporate Insurance">Corporate Patient (Company) </option>
                                <option value="SFC Insurance">SFC Patient </option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control m-bot15" name="genotype" value=''>
                            ...
                            <option value="AO">AS</option>
                            <option value="BB">AC</option>
                            <option value="BO">SS</option>
                            <option value="AB">SC</option>
                            <option value="OO">CC</option>
                        </select>
                    </div>
...
$(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            if(response.patient.patient_type !== null){
                ...
                var option1 = new Option('HMO Insurance', 'HMO Insurance', true, response.patient.patient_type == "HMO Insurance");
                var option2 = new Option('Corporate Insurance', 'Corporate Insurance', false, response.patient.patient_type == "Corporate Insurance")
                var option3 = new Option('Private Patient', 'Private Patient', false, response.patient.patient_type == "Private Patient")
                var option4 = new Option('SFC Insurance', 'SFC Insurance', false, response.patient.patient_type == "SFC Insurance")
                ...
                var option3 = new Option('Private Insurance', 'HMO Insurance', false, false)
                var option4 = new Option('SFC Insurance', 'SFC Insurance', false, false)
            }
            if( response.patient.patient_type == "Private Patient"){
                ...
                if(response.hmo){
                    ...
                    if(response.sponsor){
                        var option112 = new Option(response.sponsor.name , response.patient.insurance_sponsor, true, true);
                        $('#editPatientForm').find('[name="sponsor"]').append(option112).trigger('change');
                    }
                }
            }
            ...
            $('#editPatientForm').find('[name="patient_type"]').append(option4).trigger('change');
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "patient/getPatient<?php echo $link;?>",
                type: 'POST',
            },
            scroller: {
