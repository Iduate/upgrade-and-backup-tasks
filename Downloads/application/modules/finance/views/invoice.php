            ...
            <div class="panel panel-primary" id="invoice">
                ...
                <div class="panel-body" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <img alt="" src="<?php echo $this->settings_model->getSettings()->logo; ?>" width="100%">
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6 pull-left row" style="text-align: left;">
                                ...
                                <?php 
                                    if($patient_info->patient_type != "Private Patient"){
                                    $hmo=$this->finance_model->getHMOById($patient_info->insurance_id);
                                ?>
                                <div class="col-md-12 row details" style="">
                                    <p>
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        ...
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($patient_info)) {
                                                echo $patient_info->policy_no . ' <br>';
                                            }
                                            ?>
                                        </span>
                                    </p>
                            ...
                            if (!empty($payment->category_name)) {
                                ...
                                foreach ($category_name1 as $category_name2) {
                                    ...
                                    if ($category_name3[3] > 0) {
                                        $paymentCat=$this->finance_model->getPaymentcategoryById($category_name3[0]);
                                        $isHMO="";
                                        if($hmo != null){
                                            $hh=$this->finance_model->getHMOCategoryPrice($hmo->id,$category_name3[0]);
                                            if($hh != null)
                                                $isHMO=" (HMO)";
                                        }
                                        ?>  
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?> </td>
                                            <td><?php echo $paymentCat->category.$isHMO; ?> </td>
