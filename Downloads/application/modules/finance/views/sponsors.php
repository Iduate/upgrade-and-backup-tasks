    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  Add Insurance Sponsor</h4> 
            </div>
            <div class="modal-body row">
                <form role="form" action="finance/addSponsorInsurance" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <section class="col-md-12">
                        <input type="hidden" name="insurance_id" value="<?php echo $this->input->get("id");?>"/>
