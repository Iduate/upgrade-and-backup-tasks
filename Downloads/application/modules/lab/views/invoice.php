            ...
            <div class="panel panel-primary" id="lab">
                ...
                <div class="panel-body" style="font-size: 13px;">
                    <div class="row invoice-list">
                        ...
                        <center style="font-size:20px; border:4px solid black; margin: 10px 10% 40px; padding:10px">Laboratory Report</center>
                    ...
                    <div class="col-md-12 panel-body" style="font-size:15px !important">
                        <?php
                        if (!empty($lab->title)) {?>
                        <center style="font-size:17px; color:black; font-weight:bold; text-decoration:underline;">
                            <?php echo $lab->report; ?>
                        </center>
