    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  Add New  Scan</h4>
            </div>
            <div class="modal-body row">
                <form role="form" action="lab/addRadiology" class="clearfix" method="post" enctype="multipart/form-data">
                    
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Scan Name</label>
                        <input type="text" class="form-control pay_in default" name="name" value=""  placeholder="Enter Scan Name"/>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Price</label>
                        <input type="text" class="form-control pay_in default" name="price" value=""/>
                    </div>
