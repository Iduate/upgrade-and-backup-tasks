                            ...
                            <?php foreach ($departments as $department) { ?>
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        ...
                                        <button type="button" style="background:#ce5106; border-color:#ce5106" class="btn btn-info btn-xs btn_width editformbutton" data-toggle="modal" title="Edit case form" data-id="<?php echo $department->id; ?>"><i class="fa fa-edit"></i> </button>   
                                        <button type="button" style="background:#009FFF; border-color:#009FFF" class="btn btn-info btn-xs btn_width formbutton" data-toggle="modal" title="Add Edit case form" data-id="<?php echo $department->id; ?>"><i class="fa fa-file"></i> </button>  
                                        <a style="background:#1B445E; border-color:#0E212D" class="btn btn-info btn-xs btn_width" title="Consultation Fee" href="department/consultfee?id=<?php echo $department->id; ?>">Fee</a> 
