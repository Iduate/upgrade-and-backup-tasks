<!DOCTYPE html>
<style>
.xerdocs_msg{width:300px; padding:10px 15px; position:fixed; bottom:20px; right:20px; 
background-color:#1a7bb9; z-index:99999999999; border-radius:20px; display:none; max-height:200px}
.x_name{color: white; font-size: 14px; font-weight: bold; margin: 0; padding-top: 5px;}
.x_msg{color: white; font-weight: bold;}
.hmsNoti{position:fixed; bottom:30px; right:30px;width:300px; display:none;
z-index:999999999999999999999999999999999999999999999999999999999999999999999999999999999;
min-height:100px; max-height:300px; overflow-y:auto; opacity:.7}
.hmsNote{width:100%; min-height:50px; max-height:100px; background:#1a7bb9;
margin:10px 0 10px; border-radius:10px; color: white;font-size: 14px;
padding: 5px 9px; font-weight:bold; display:none}

#dialogwrap{position:fixed; width:100%; height:100%; z-index:999999; visibility:hidden; overflow:scroll}
#dialogoverlay{ opacity:0;position:fixed;top:0;left:0;background:black; width:100%;z-index:9999999; height:100%; visibility:hidden;
transition:opacity 0.3s linear 0s; -o-transition:opacity 0.3s linear 0s; -webkit-transition:opacity 0.3s linear 0s;
-moz-transition:opacity 0.3s linear 0s;}
#dialogbox{border-radius:20px; padding:10px 20px; transform:scale(0); position:absolute; background:white; z-index:999999991; width:78%; display:none; transition:transform 0.2s linear 0s;
-o-transition:transform 0.2s linear 0s; -moz-transition:transform 0.2s linear 0s; -webkit-transition:transform 0.2s linear 0s;}
#dialogbox > div > #dialogboxhead{min-height:16.43px; padding: 15px; border-bottom:1px solid #f4f4f4;}
#dialogbox > div > #dialogboxbody{background-color:white;padding:10px; text-align:center; font-size:14px;}
#dialogbox > div > #dialogboxfoot{background-color:white; text-align:right; border-top:1px solid #d5d5d5; padding-top:5px; width:100%;}
#dialogbox > div > #dialogboxfoot >button{background:black; color:white;}
#dialogimg{display:none; position:fixed; z-index:999999999;  font-family:oswald;}
.adverteeseinfo{position:fixed; width:200px; padding:15px 10px; right:0; top:10px; background-color:green; color:white; font-weight:bold; font-family:sans-serif;  transition:opacity 0.5s linear 0s; -moz-transition:opacity 0.5s linear 0s; -ms-transition:opacity 0.5s linear 0s; -o-transition:opacity 0.5s linear 0s; -webkit-transition:opacity 0.5s linear 0s; font-size:14px; opacity:1; z-index:99999999999999999999999 !important; opacity:0; display:none;}
.adverteeseinfo i{float:left; width:20px; font-size:20px;}
.adverteeseinfo p{float:right; margin:0; width:159px;}
.clr{clear:both;}
</style>
...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    if ($settings_lang == 'arabic') {
      ...
      <?php
        ...
        if ($this->ion_auth->in_group(array('Laboratorist'))) {
            ...
            $rNum=$this->lab_model->getNewRequest();
            if($rNum >1){
                $count=" ($rNum)";
            }
        }
    ...
    <body>
        ...
        <div id='dialogbox'><div><div id='dialogboxhead'></div><div id='dialogboxbody'></div><div id='dialogboxfoot'></div></div></div></div>

        <a href="#" id="x_a">
        <section class="xerdocs_msg">
            <p class="x_name">Victory Christian:</p>
            <p class="x_msg">Hello bro; how body</p>
        </section>
        </a>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin','Accountant','Record_Officer'))) { ?>
                                <li><a href="home/operations"><i class="fa fa-medkit"></i>Operations</a></li>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            ...
                            <?php } ?>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist','Record_Officer'))) { ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                    ...
                                    <ul class="sub"> 
                                        ...
                                        <li><a href="patient/inPatient"><i class="fa fa-user"></i>In Patient List</a></li>
                                        <li><a href="patient/walkinPatient"><i class="fa fa-user"></i>Walk In Patient</a></li>
                                        <li><a href="patient?checkin=1234"><i class="fa fa-user"></i> Check-in List</a></li>
                                        
                                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                            <li><a href="patient/today"><i class="fa fa-user"></i> Today Patient</a></li>
                                        <?php } ?>

                                        <li><a href="patient/birthdays"><i class="fa fa-birthday-cake"></i> Birthdays</a></li>
                                        <?php if ($this->ion_auth->in_group(array('Doctor', 'admin'))) { ?>
                                            <li><a href="patient/symptom"><i class="fas fa-file-medical-alt"></i>Symptom Manager</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('Doctor', 'Receptionist', 'Nurse'))) { ?>
                                            <li><a href="patient/vitals"><i class="fa fa-heartbeat"></i>Vitals</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('Receptionist','admin'))) { ?>
                                            <li><a href="patient/mergeFolder"><i class="fa fa-user"></i> Merge Patient</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('Doctor', 'Receptionist', 'Nurse','Record_Officer','admin'))) { ?>
                                            <li><a href="patient/patientHistory"><i class="fa fa-stethoscope"></i>History</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array( 'Nurse'))) { ?>
                                            <li><a href="patient/vitalsAppointment"><i class="fa fa-list"></i>Vitals Schedule</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                                            <li><a href="patient/viewConsultation"><i class="fa fa-user-md"></i>Consultation</a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                            <li><a href="patient/add_vitals"><i class="fa fa-heartbeat"></i>Vitals</a></li>
                                        <?php } ?>
                                        ...
                                        <?php } ?>
                                        <?php if (!$this->ion_auth->in_group(array('Accountant','Record_Officer'))) { ?>
                                            <li><a href="patient/caseList"><i class="fa fa-book"></i><?php echo lang('case'); ?> List</a></li>
                                            <li><a href="patient/documents"><i class="fa fa-file"></i><?php echo lang('documents'); ?></a></li>
                                        <?php } ?>
                                        <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                                            <li><a href="patient/caseManager"><i class="fa fa-book"></i><?php echo lang('case'); ?> <?php echo lang('manager'); ?></a></li>
                                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="department/admin"><i class="fa fa-user"></i><?php echo lang('admin'); ?></a></li>
                                    <?php if (in_array('medicine', $this->modules)) { ?>
                                    ...
                                    <?php if (in_array('medicine', $this->modules)) { ?>
                                        ...
                                        <li><a href="accountant/record_office"><i class="fa fa-user"></i>Record Officer</a></li>
                                    <?php } ?>
                                    <?php if (in_array('medicine', $this->modules)) { ?>
                            ...
                            <?php if (in_array('finance', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li><a  href="finance/manageInsurance"><i class="fa fa-user-md"></i>Manage Insurance</a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Pharmacist'))) { ?>
                            <?php if (in_array('prescription', $this->modules)) { ?>
                                ...
                                <li>
                                    <a href="prescription/dispensed" >
                                        <i class="fas fa-prescription"></i>
                                        <span> Dispensed Lists </span>
                                    </a>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Laboratorist'))) { ?>
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                       <?php if ($this->ion_auth->in_group(array('Doctor'))) {?>
                                         <li><a  href="lab/requestTest"><i class="fa fa-industry"></i> Request Test</a></li>
                                       <?php } else if($this->ion_auth->in_group(array('Laboratorist','admin'))){?>
                                            <li><a  href="lab/requestList"><i class="fa fa-industry"></i><?php echo "Lab Test Request", $count ?></a></li>
                                            <li><a  href="lab/testList"><i class="fa fa-flask"></i><?php echo "List of Lab Test"; ?></a></li>
                                       <?php } ?>
                                        <li><a  href="lab"><i class="fa fa-plus-circle"></i><?php echo lang('add_lab_report'); ?></a></li>
                                       <?php if($this->ion_auth->in_group(array('admin','Laboratorist'))){?>
                                        <li><a  href="lab/addLabView"><i class="fa fa-file-medical"></i><?php echo lang('lab_reports'); ?></a></li>
                                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Radiologist'))) { ?>
                            <?php if (in_array('lab', $this->modules)) { ?>
                                <li class="sub-menu">
                                    <a href="javascript:;" >
                                    ...
                                    <ul class="sub">
                                         <!-- <li><a  href="lab/operations"><i class="fa fa-industry"></i> Operations</a></li> -->
                                         <li><a  href="lab/rad_requests"><i class="fa fa-industry"></i> Requests</a></li>
                                        <li><a  href="lab/RadiologyReport"><i class="fa fa-file-medical"></i> Radiology Report</a></li>
                                        <li><a  href="lab/RadiologyList"><i class="fa fa-x-ray"></i> Radiology List</a></li>
                                        <li><a  href="lab/addRad"><i class="fa fa-plus"></i> Add Report</a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group('Accountant')) { ?>
                            <?php if (in_array('finance', $this->modules)) { ?>
                                ...
                                <li>
                                    <a  href="finance/manageInsurance">
                                        <i class="fa fa-user-md"></i>
                                        <span>Manage Insurance</a></span>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        ...
                        <?php if ($this->ion_auth->in_group('superadmin')) { ?>
                            ...
                            <li>
                                <a href="hospital/active_patients">
                                    <i class="fa fa-sitemap"></i>
                                    <span>Patient</span>
                                </a>
                            </li>
                        ...
                        <?php if (true) { ?>
                            <li class="sub-menu">
                                <a href="javascript:;" >
                                    ...
                                    <span>Hosptial Record</span>
                                </a>
                                <ul class="sub"> 
                                    <li><a href="accountant/frontDeskRecord"><i class="fa fa-file"></i>Front Desk Record</a></li>
                                    <li><a href="prescription/pharmacyReport"><i class="fa fa-file"></i>Pharmacy Record</a></li>
                                    <li><a href="patient/consultationReport"><i class="fa fa-file"></i>Consultation Record</a></li>
                                    <li><a href="patient/registrationReport"><i class="fa fa-file"></i>Registration Record</a></li>
                                    <li><a href="lab/xrayReport"><i class="fa fa-file"></i>Scan & Xray Record</a></li>
                                    <li><a href="lab/labReport"><i class="fa fa-file"></i>Lab Record</a></li>
                                    <li><a href="accountant/accountReport"><i class="fa fa-file"></i>Account Record</a></li>
                                    <li><a href="patient/patientReport"><i class="fa fa-file"></i>Patient Record</a></li>
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        <?php if (true) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <?php if ($this->ion_auth->in_group('admin')) { ?> 
                                    <li><a href="home/tutorials?group=admin"><i class="fa fa-file"></i>Admin</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Doctor','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=doctor"><i class="fa fa-file"></i>Doctor</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Nurse','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=nurse"><i class="fa fa-file"></i>Nurse</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Receptionist','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=front"><i class="fa fa-file"></i>Front Desk</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Laboratorist','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=lab"><i class="fa fa-file"></i>Laboratorist</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Pharmacist','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=pharmacists"><i class="fa fa-file"></i>PHarmacist</a></li>
                                    <?php }?>
                                    <?php if ($this->ion_auth->in_group(array('Accountant','admin'))) { ?> 
                                    <li><a href="home/tutorials?group=account"><i class="fa fa-file"></i>Accountant</a></li>
                                    <?php }?>
                                </ul>
                            </li>
                        <?php } ?>
...
function addNote(url,note){
    $(document).ready(function(){
        var newNote="<a id='xnote' data-href='"+url+"'>"+
        "<div class='hmsNote'>"+note+
        "</div>";
        $(".hmsNoti").append(newNote);
        $(".hmsNoti").fadein();
        setTimeout(() => {
                    $(".hmsNoti").fadeOut();
                },5000);
...
i=0
// setInterval(() => {
// addNote("#","This is a note that i am adding every 7 seconds, hope it is cool "+i)
// i++;
// },7000);

$(document).ready(function(){
    $("#xnote").click(function(){
        console.log("dfasf")
    })
});
</script>
