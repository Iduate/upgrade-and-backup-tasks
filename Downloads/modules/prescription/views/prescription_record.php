    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                Pharmacy Report
                <form action="prescription/pharmacyReport" method="get">
                    ...
                    <div class="form-group col-md-2  insClass" id="sponsorwrap" >
                        <select class="form-control m-bot15" name="medicine" value='' id="med_select"  onchange="hideInsurance()">
...
if(!empty($this->input->get("medicine"))){
    $link.="&medicine=".$this->input->get("medicine");
}
...
?>
    ...
    $(document).ready(function () {
        var table = $('#editable-sample1').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "prescription/getPharmacyReport<?php echo $link;?>",
                type: 'POST',
            },
            scroller: {
