...
class Patient extends MX_Controller {
    ...
    function consultation(){
        ...
        //add the payment
        $current_item = $this->finance_model->getPaymentCategoryByOperation("Consultation");
...
// Validating Deposited Amount Field
    ...
    function getPatient() {
        ...
        foreach ($data['patients'] as $patient) {
            ...
            if ($this->ion_auth->in_group(array('Nurse', 'Receptionist'))) {
    ...
    function checkinPatient(){
        ...
        if($this->patient_model->isPatientCheckedIn($id) ){
            ...
            $this->patient_model->checkinPatient($data);
            $data["res"]="true";
            echo json_encode($data);
        }
    }
    ...
    function checkOutPatient(){
        ...
        if($this->patient_model->isPatientCheckedIn($id) ){
            ...
            $this->patient_model->checkoutPatient($data);
            $data["res"]="true";
            echo json_encode($data);
        }else{
            $data["res"]="true";
