    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                Consultation Report
                <form action="patient/consultationReport" method="get">
...
if(!empty($this->input->get("doctor"))){
    $link=$link."&doctor=".$this->input->get("doctor");
}
?>
    ...
    $(document).ready(function () {
        var table = $('#editable-sample1').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "patient/getConsultationReport<?php echo $link;?>",
                type: 'POST',
            },
            scroller: {
