    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <form action="accountant/frontDeskRecord" method="get">
                    ...
                    <div class="form-group col-md-2">
                        <select class="form-control m-bot15" name="dept" id="" value=''>
...
if(!empty($this->input->get("dept"))){
    $link=$link."&dept=".$this->input->get("dept");
}
...
?>
    ...
    $(document).ready(function () {
        ...
        var table = $('#editable-sample').DataTable({
            ...
            "searchable": true,
            "ajax": {
                url: "accountant/getFrontDesk<?php echo $link;?>",
                type: 'POST',
            },
            scroller: {
